...
public class JFramePrincipal extends JFrame
{
  ...
  //JTextPane jTextPaneInformacion = cFtp.getJTextPane();
  ...
  /**
   * Frame principal de cFtp. Este frame se ha generado con el editor gráfico,
  ...
  {
    //Cargar imágenes...
    ImageIconLogoOff = new ImageIcon(cFtp.getImage("grey_ball.gif"));
    ImageIconLogoOn = new ImageIcon(cFtp.getImage("green_ball.gif"));
  ...
  private void iniciarEstilos()
  {
   //Iniciar estilos
    // ================ Panel Información =========================
    cFtp.iniciarStylesJTextPane(jTextPaneInformacion);
    copyright();
    jTextPaneInformacion.getLayout().addLayoutComponent("jTextPaneInformacion",jTextPaneInformacion);


    // ================ Panel Receptores  =========================
    cFtp.iniciarStylesJTextPane(jTextPaneReceptor);
    cFtp.insertRecepcionString("Receiver","icono_informacion");


    // ================ Panel Transmisor  =========================
    cFtp.iniciarStylesJTextPane(jTextPaneTransmisor);
    cFtp.insertTransmisionString("Sender","icono_informacion");
            ...
            public void valueChanged(TreeSelectionEvent e)
            {
              ...
              //                         jTreeInformacion.getLastSelectedPathComponent();
                ...
                if (node.isLeaf())
                {
                  ...
                  //cFtp.insertInformacion(jTextPaneInformacion,"panel cambiado");
  ...
  private void jbInit() throws Exception
  {
    ...
    jLabel3.setText(" clusterNET - cFtp v1.2");
   ...
   //this.setContentPane(jPanelContentPanel);
    ...
    jLabel1.setText(" (C)2016 clusterNET - cFtp, a cluster ftp program");
  ...
  {
    //Conectar.
    //cFtp.getFTP().getJDialogConectar().show();
  }
  ...
  void jButtonTxEnviar_actionPerformed(ActionEvent e)
  {
    ...
    if( this.jFileChooser.showDialog(this,"Send") == JFileChooser.APPROVE_OPTION )
    {
       ...
       {
          JOptionPane.showMessageDialog(this,"Any file selected for transmission."+cFtp.newline+"Please, select a file"+cFtp.newline+"You can use double click on the directory tree ","File don't selected.",JOptionPane.INFORMATION_MESSAGE);
          return;
       }
       ...
       if (JOptionPane.showConfirmDialog(this,"Send file "+this.jFileChooser.getSelectedFile().getAbsolutePath(),"Confirmación",JOptionPane.OK_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE) == JOptionPane.OK_OPTION)
       {
           ...
           {
             JOptionPane.showMessageDialog(this,"There isn't multicast connection."+cFtp.newline+"Please init a multicast connection"+cFtp.newline+"Push \"Connect\" button"+cFtp.newline+"to init a new multicast connection","Disconnect",JOptionPane.INFORMATION_MESSAGE);
             return;
           }
  ...
  void copyright()
  {
    cFtp.insertInformacionString(cFtp.COPYRIGHT);
    cFtp.insertInformacionString(" "+cFtp.VERSION);
  ...
  */
  void logoOn()
  {
    ...
    cFtp.getFTP().insertRecepcionString("Receiver","icono_informacion");

    this.jTextPaneTransmisor.setText("");
    cFtp.getFTP().insertTransmisionString("Sender","icono_informacion");

    if(cFtp.getFTP().esEmisor())
    {

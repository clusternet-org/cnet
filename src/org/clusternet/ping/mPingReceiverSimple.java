 ...
 * @version 1.0
 */
public class mPingReceiverSimple {
...
* Constructor
*/
public mPingReceiverSimple(String dirIPMulticast, String puerto) throws IOException
{
System.out.println("");
System.out.println("");
System.out.println("mPingReceiverSimple v1.1");
...
try
{
    mPingReceiverSimple mescucha = new mPingReceiverSimple(args[0],args[1]);
    mescucha.run();
}
...
{
System.out.println("");
System.out.println("mPingReceiverSimple v1.0" );
System.out.println("Uso: java org.clusternet.tools.mPingReceiver <dir. ip multicast> <puerto>");
System.out.println("");
System.out.println("");
}

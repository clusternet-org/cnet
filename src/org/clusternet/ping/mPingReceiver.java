    ...
    while(true)
    {
     try
     {
       ...
       // Log.log(""+contador,sMensaje);
        Log.log(""+contador,sMensaje+" from "+add.getHostAddress()+":"+dirIPMcast.getPort());
...
System.out.println("");
System.out.println("mPingReceiver v1.1" );
System.out.println("Uso: java org.clusternet.ping.mPingReceiver <multicast address> <port>");
System.out.println("");
System.out.println("");
}

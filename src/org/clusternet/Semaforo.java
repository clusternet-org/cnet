...
//----------------------------------------------------------------------------
//
//	Fichero: ClusterNet.java  1.0 23/11/99
//
...
public class Semaforo
{
  ...
  public  Semaforo(boolean binario, int contador) throws ClusterNetInvalidParameterException
  {
    if (binario && (contador > 1))
      throw new ClusterNetInvalidParameterException("Semaforo.Semaforo","Intento de crear un semáforo binario con un contador mayor que uno.");

    if (contador < 0)
      throw new ClusterNetInvalidParameterException("Semaforo.Semaforo","El parámetro contador es menor que cero.");

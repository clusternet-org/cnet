...
public class TPDUHSACK extends TPDUDatos
{
   ...
   */
  private TPDUHSACK (SocketClusterNetImp socketClusterNetImp)
  ...
  * @exception ClusterNetExcepcion si hay un error al crear el TPDUHSACK

  */
 static TPDUHSACK crearTPDUHSACK (SocketClusterNetImp socketClusterNetImp,
                                  IPv4 dirIPFuente,
                                  SecuenceNumber nSec,
   ...
   throws ClusterNetInvalidParameterException, ClusterNetExcepcion
 {
   ...
   TPDUHSACK resultTPDU = new TPDUHSACK (socketClusterNetImp);
   ...
   */
 Buffer construirTPDUHSACK () throws ClusterNetExcepcion,ClusterNetInvalidParameterException
 {
  final String mn = "TPDU.construirTPDUDatos";
  int offset = 14;

   // Crear la cabecera común a todos los TPDU
   Buffer bufferResult =super.construirCabeceraComun (ClusterNet.SUBTIPO_TPDU_DATOS_HSACK,
   ...
   throws ClusterNetExcepcion,ClusterNetInvalidParameterException
 {
  ...
  if (tpduHSACK.SUBTIPO != ClusterNet.SUBTIPO_TPDU_DATOS_HSACK)
         throw new ClusterNetExcepcion (mn+ "Subtipo de TPDU Datos no es HSACK");
  ...
  // 25º, 26º, 27º y 28º BYTE : Número de secuencia
  //
  tpduHSACK.NUMERO_SECUENCIA_FUENTE = new SecuenceNumber (buffer.getInt (offset));
  offset += 4;
...

 {
   ...
   return "===================================================="+
          ...
          "\nSubtipo: " + ClusterNet.SUBTIPO_TPDU_DATOS_HSACK+
          "\n====================================================";

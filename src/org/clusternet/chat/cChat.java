/**
  ...
  Copyright (c) 2016 . All Rights Reserved. ClusterNet
  @Autor: Alejandro García Domínguez alejandro.garcia.dominguez@gmail.com
...
/**
 * 	<b>Una Interfaz para cChat, con soporte de
...
public class cChat implements I18n
{
  ...
  * Constructor genérico para un applet y una aplicación.
	...
	*/
	public cChat(javax.swing.JApplet unApplet) {
		 super();
		 jApplet = unApplet;
 ...
 public Image getImage(String fileName)
 {
        ...
        //Obtener la imágen...
        URL url = cChat.class.getResource(fileName);
...
//==========================================================================
  ...
  */
  JLabel getJLabelID_Sockets()
  {
	 	if (jLabelID_Sockets == null) {
			try
      {
				jLabelID_Sockets = new JLabel("Members: 0");
  ...
  */
  JLabel getJLabelIDGLs()
  {
	 	if (jLabelIDGLs == null) {
			try
      {
				jLabelIDGLs = new JLabel("Groups: 0");
  ...
  */
  private JMenuItem getJMenuItemID_Sockets()
  {
	 	if (jMenuItemID_Sockets == null) {
			try {
				jMenuItemID_Sockets = new JMenuItem("Members");
  			jMenuItemID_Sockets.setName("JMenuItemID_Sockets");
  			jMenuItemID_Sockets.setToolTipText("Members que pertenecen a nuestro Grupo Local");
  ...
  */
  private JLabel getJLabelLogo()
  {
			...
			try
      {
        ...
        //Cargar imágenes...
        ImageIconLogoOff = new ImageIcon(getImage("grey_ball.gif"));
        ImageIconLogoOn = new ImageIcon(getImage("green_ball.gif"));

        logoOff();
        jLabelLogo.setAlignmentX(Component.RIGHT_ALIGNMENT);
        jLabelLogo.setToolTipText("clusterNet ;-)");
  		}
			catch (java.lang.Throwable e) {
					handleException(e);
			}
  ...
  * @param nickName NickName utilizado en la sesion Chat Multicast
            ...
            int modo, String nickname,char[] clave)
  {
      ...
      this.getJFrame().setTitle("clusterNet: cChat - "+sIPMulticast+":"+ttlSesion);
 ...
 //==========================================================================
 /**
  * Inserta el logotipo de ClusterNet en el panel de texto.
  */
 ...
 class ActionListenerAcercaDe implements ActionListener {
          ...
          (getContainer(), iString(ABOUT),
            ...
            new ImageIcon(getImage("clusterNET.jpg")));

...
//----------------------------------------------------------------------------
//
//	Fichero: ClusterMemberID.java  1.0 21/10/99
//
//	Description: ClusterMemberID
//
//
// 	Authors: 
...
/**
 * ClusterMemberID identifica a un Socket ClusterNet dentro de Internet.
 ...
 */
 public class ClusterMemberID implements Cloneable, Comparable{
   ...
   */
  ClusterMemberID(IPv4 ipv4, int puerto)
  {
    super();
  ...
  public Object clone()
  {
   return ( new ClusterMemberID((IPv4)this.ipv4.clone(),this.PuertoUnicast));
  }
 ...
 public int compareTo(Object obj)
 {
    int hash1 = 0;
    int hash2 = 0;
    ClusterMemberID id = (ClusterMemberID) obj;

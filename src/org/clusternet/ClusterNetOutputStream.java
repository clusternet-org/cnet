...
//----------------------------------------------------------------------------
//
//	File: ClusterNetOutputStream.java  1.0 24/11/99
//
//	Description: Clase ClusterNetOutputStream.
//
// 	Authors: 
...
/**
 * ClusterNetOutputStream es un flujo de salida para ClusterNet.
 * @version  1.0
 * @author M. Alejandro García Domínguez
 * <A HREF="mailto:alejandro.garcia.dominguez@gmail.com">(alejandro.garcia.dominguez@gmail.com)</A><p>
 *			   Antonio Berrocal Piris
 */
public class ClusterNetOutputStream extends OutputStream
{
  ...
  /**
   * Constructor.
   * @param socketClusterNetImp El objeto SocketClusterNetImp
   */
  ClusterNetOutputStream(SocketClusterNetImp socketClusterNetImp)
  {
   super();
   ...
   */
   public void write(byte[] b, int off, int len) throws IOException
   {
      ...
      if(!this.socketClusterNetImp.getColaEmision().esActiva())
        throw new IOException("Se ha desactivado la emisión de datos en el ClusterNet.");

      if((off == 0) && (b.length <= len))
      {
          // añadir el array de bytes entero...
           encolado = this.socketClusterNetImp.getColaEmision().add(b,off,len,false);
      }
      else
      {
         // Comprobar longitud
         if( off + len > b.length)
           throw new IOException("ClusterNetOutputStream.write: Número de bytes a copiar incorrecto");
      ...
      if (encolado)
         ...
         throw new IOException("ClusterNetOutputStream.write: No se pudo escribir en el flujo de salida");
   ...
   * de nuevo a getMulticastOutputStream() en el ClusterNet, este método
   ...
   */
   public void close() throws IOException
   {
      ...
      this.socketClusterNetImp.getColaEmision().add(abyte,0,1,true);

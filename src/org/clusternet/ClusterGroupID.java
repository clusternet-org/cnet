...
//----------------------------------------------------------------------------
//
//	File: ClusterGroupID.java  1.0 21/10/99
//
//
//	Description: ClusterGroupID
//
// 	Authors: 
...
/**
 * ClusterGroupID encapsula el identificador del grupo local:
 *  ClusterGroupID = IPv4 + Puerto Unicast
 *
 *
 ...
 */
public class ClusterGroupID implements Cloneable ,Comparable{
   ...
   */
  ClusterGroupID(Buffer id, byte ttl)
  {
    super();
    ...
    {
      //Error fatal.
      Log.log("ClusterGroupID()","ERROR FATAL: ClusterGroupID menor de 6 bytes.");
      Log.exit(-1);
    }
 ...
 /* ClusterGroupID()
  ...
  public Object clone()
  {
     return new ClusterGroupID((Buffer)this.id.clone(),(byte)this.TTL);
  }
  ...
  //==========================================================================
  /**
   * Devuelve el código hash para este ClusterGroupID.
   * El código hash se basa sólo en el identificador del grupo local.
   * @return el código hash para el ClusterGroupID
   */
  ...
  {
    ClusterGroupID clusterGroupID = (ClusterGroupID) obj;

    //if (this.TTL == clusterGroupID.TTL)
    //{
      for (int i=0; i< 6; i++)
       if (this.id.getBuffer()[i] != clusterGroupID.id.getBuffer()[i])
        return false;
   ...
   * @param o ClusterGroupID con la que se compara.
 ...
 public int compareTo(Object o)
 {
  ...
  //==========================================================================
  /**
   * DEVUELVE ClusterGroupID COMO UN LONG PARA AÑADIR A LOS TPDU
   */
  public long getIDGL ()
  {
  ...
  {
   return ("[ClusterGroupID: "+getStringID()+"] TTL="+this.TTL);
  }

...
import java.util.TreeMap;
  ...
  private void receiveFile()  throws IOException
 {
     ...
     try
     {
      if(receptorFTPMulticast.getModo() == ClusterNet.MODE_DELAYED_RELIABLE
      || receptorFTPMulticast.getModo() == ClusterNet.MODE_RELIABLE)
      {
        // System.out.println("");
  ...
  finally
  {
     ...
     if(this.receptorFTPMulticast.getModo() == ClusterNet.MODE_DELAYED_RELIABLE
     || receptorFTPMulticast.getModo() == ClusterNet.MODE_RELIABLE)
     {
         this.receptorFTPMulticast.removeFileRecepcion(this.id_socketIn);
     }
...
*/
 ...
 private boolean receiveIDFTPMulticast() throws IOException
 {
   ...
   try
   {
    ...
    System.out.println("");
    System.out.println("");
    Log.log(receptorFTPMulticast.mn,"Iniciando la recepcion cFtp...");
    //System.out.println("--------------------------------------");

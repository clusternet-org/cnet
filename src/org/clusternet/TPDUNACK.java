...
public class TPDUNACK extends TPDUDatos
{
   ...
   */
  private TPDUNACK (SocketClusterNetImp socketClusterNetImp)
  ...
  * @exception ClusterNetExcepcion si hay un error al crear el TPDUNACK
  */
 static TPDUNACK crearTPDUNACK (SocketClusterNetImp socketClusterNetImp,
   ...
   throws ClusterNetInvalidParameterException, ClusterNetExcepcion
 {
   ...
   resultTPDU = new TPDUNACK (socketClusterNetImp);
   ...
   */
 Buffer construirTPDUNACK () throws ClusterNetExcepcion,ClusterNetInvalidParameterException
 {
  ...
  int offset = 14;
   ...
   Buffer bufferResult = construirCabeceraComun (ClusterNet.SUBTIPO_TPDU_DATOS_NACK,tamaño);

   if (bufferResult==null)
        throw new ClusterNetExcepcion (mn + "Error al construir el buffer");
   ...
   throws ClusterNetExcepcion,ClusterNetInvalidParameterException
 {
  ...
  if (tpduNACK.SUBTIPO != ClusterNet.SUBTIPO_TPDU_DATOS_NACK)
      throw new ClusterNetExcepcion (mn+"Subtipo del TPDU Datos no es NACK");
...
          "\nSubtipo: " + ClusterNet.SUBTIPO_TPDU_DATOS_NACK

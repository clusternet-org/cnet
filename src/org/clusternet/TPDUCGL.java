...
/**
 * Clase TPDU CGL (Control de Grupo Local) de ClusterNet.<br>
...
class TPDUCGL extends TPDU implements Cloneable
{
   ...
   */
  private TPDUCGL() throws ClusterNetExcepcion, ClusterNetInvalidParameterException
  {
    super();
   ...
   */
  private TPDUCGL(SocketClusterNetImp socketClusterNetImp) throws ClusterNetExcepcion, ClusterNetInvalidParameterException
  {
   ...
   throws ClusterNetInvalidParameterException, ClusterNetExcepcion
  {
    ...
    resultTPDU = new TPDUCGL (socketClusterNetImp);
    ...
    switch(SUBTIPO)
    {
          ...
          case ClusterNet.TPDU_CGL_GL_PARA_EMISOR:
          case ClusterNet.TPDU_CGL_BUSCAR_GL_PARA_EMISOR:
          case ClusterNet.TPDU_CGL_GRUPO_LOCAL_VECINO:
           break;

          default:
           throw new ClusterNetInvalidParameterException(mn, "Subtipo de cabecera TPDU CGL incorrecta.");
    }
    ...
    {
      if (ID_SOCKET == null)
        throw new ClusterNetInvalidParameterException(mn,"Parámetro ID_SOCKET nulo.");
   ...
   * @exception ClusterNetExcepcion Se lanza si ocurre algún error en la construcción
   * del TPDU
   * @exception ClusterNetInvalidParameterException lanzada si ocurre algún error en la
   * construcción del TPDU
   */
  Buffer construirTPDU() throws ClusterNetExcepcion,ClusterNetInvalidParameterException
  {
    ...
    bufferResult = construirCabeceraComun ((short)ClusterNet.TPDU_CGL,this.tamaño);
    ...
    try
    {
      ...
      if ((this.IP == 0) && (this.N_IDS > 0) && (this.treeMapIDGL != null))
      {
        ...
        if (this.SUBTIPO== ClusterNet.TPDU_CGL_GRUPO_LOCAL_VECINO
   ...
   * @exception ClusterNetInvalidParameterException Se lanza si buffer no contiene un
   *  TPDUCGL válido.
   */
    ...
    throws ClusterNetExcepcion, ClusterNetInvalidParameterException
  {
    ...
    switch (tpduCGL.TIPO)
    {
       case ClusterNet.TPDU_CGL:
        break;
       default:
         throw new ClusterNetExcepcion(mn, "Cabecera TPDU CGL no válida. El campo TIPO debe de ser 00, encontrado valor "+(tpduCGL.TIPO & 0x2 )+(tpduCGL.TIPO & 0x1));
    }
    ...
    switch (tpduCGL.SUBTIPO)
    {
       ...
       case ClusterNet.TPDU_CGL_BUSCAR_GRUPO_LOCAL_VECINO:
       case ClusterNet.TPDU_CGL_BUSCAR_GL_PARA_EMISOR:
       case ClusterNet.TPDU_CGL_GL_PARA_EMISOR:      break;
       case ClusterNet.TPDU_CGL_GRUPO_LOCAL_VECINO: bGLVecino=true;  break;
       default:
         throw new ClusterNetExcepcion(mn, "Cabecera TPDU CGL no válida. El campo SUBTIPO no es válido, encontrado valor "
   ...
   */
  static int getN_Secuencia(Buffer buf) throws ClusterNetExcepcion
  {

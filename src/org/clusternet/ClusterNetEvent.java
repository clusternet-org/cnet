...
//------------------------------------------------------------
//
//	Fichero: ClusterNetEvent.java  1.0 30/08/99
//
//
// 	Authors: 
...
/**
 * La clase ClusterNetEvent es una clase base para todos los eventos utilizados
 * por ClusterNet
 */
public class ClusterNetEvent extends EventObject
{
 ...
 /** Identificativo de una notificación de un Error*/
   ...
   */
  public ClusterNetEvent(SocketClusterNetImp socket,int tipo_evento,String sInformativa)
  {
    super(socket);

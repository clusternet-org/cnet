 ...
 */
public class TxWindow extends Window
{
  ...
  */
 public TxWindow (int iTamañoMaximo,long lNSecInicial)
                                throws ClusterNetInvalidParameterException
 {
  super (iTamañoMaximo,lNSecInicial);

  final String mn = "TxWindow.VentanaEmision (tamañoMax,nSecInic)";
...
public /*synchronized */TPDUDatosNormal addTPDUDatosNormal (long lNSec,TPDUDatosNormal pqt)
                throws ClusterNetInvalidParameterException
{
 final String mn = "TxWindow.addTPDUDatosNormal (nSec,tpduDatosNormal)";
...
// al intentar añadirlo el método super.addTPDUDatosNormal lanzará la excepción.
  ...
  if ( (this.getNumSecInicial()==lNSec) || (this.contieneTPDUDatosNormal (lNSec-1)) )
     ...
     throw new ClusterNetInvalidParameterException ("Número de secuencia no consecutivo: "+lNSec);
...
{
 final String mn = "TxWindow.removeTPDUDatosNormal ()";
...
{
 final String mn = "TxWindow.removeTPDUDatosNormal (nSec)";

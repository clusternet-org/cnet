...
public class ListaOrdID_TPDU implements Cloneable
  ...
  */
   ...
   */
   public SortedMap getSublistaMayorIgual (ID_Socket id_socket,SecuenceNumber nSec)
   {
    ...
    try {
     ...
     ID_TPDU id_tpduLimSuperior = new ID_TPDU (id_socket,SecuenceNumber.LIMITESUPERIOR);
  ...
  public SortedMap getSublistaMenorIgual (ID_Socket id_socket,SecuenceNumber nSec)
  {
    ...
    // indicado, mayores o iguales al dado.
    try {
     ID_TPDU id_tpduLimInferior = new ID_TPDU (id_socket,SecuenceNumber.LIMITEINFERIOR);
     SecuenceNumber nSecSiguiente = new SecuenceNumber (nSec.tolong()+1);

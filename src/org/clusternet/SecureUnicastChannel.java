...
//----------------------------------------------------------------------------
//
//	File: SecureUnicastChannel.java  1.0 15/09/99
//
//	Description: Clase SecureUnicastChannel.
//
// 	Authors: 
...
/**
 * Esta clsae representa un Channel Unicast UDP/IP SEGURO.
...
public class SecureUnicastChannel extends UnicastChannel
{
   ...
   */
  public SecureUnicastChannel(Address bindAddr,  Address ifMcast
   ,javax.crypto.Cipher cipher, javax.crypto.Cipher unCipher)
      throws ClusterNetExcepcion, IOException
  {
    final String  mn = "SecureUnicastChannel.CanalUnicastSeguro";
  ...
  {
    final String    mn = "SecureUnicastChannel.send(Buffer,Address)";
    byte[] aCifrado = null;
  ...
  public void receive(Buffer buf, Address src)
    throws ClusterNetExcepcion, ClusterNetInvalidParameterException, IOException
  {
    final String    mn = "SecureUnicastChannel.receive(Buffer,Address)";
  ...
  {
    final String  mn = "SecureUnicastChannel.setTTL(byte)";
  ...
  {
    final String  mn = "SecureUnicastChannel.setCallback(ChannelCallback,int)";
...
class UnicastThreadSeguro extends Thread
{
 /** El canal unicast que creó este thread. */
  private SecureUnicastChannel  canalObj = null;
   ...
   */
   public UnicastThreadSeguro(SecureUnicastChannel canal, MulticastSocket sock)
  {
   ...
   * a la clase SecureUnicastChannel cual es el objeto callback registrado y su
   * argumento.
   */
  public void run()
  {

...
//------------------------------------------------------------
//
//	File: ClusterNetGroupListener.java  1.0 24/9/99
//
//
//	Description: Clase ClusterNetGroupListener.
//
// 	Authors: 
...
/**
 * Interfaz ClusterNetRxDataListener.
 * Notificación de eventos ClusterNetEventNewData<br>
...
public interface ClusterNetRxDataListener
{
  //==========================================================================
  /**
   * El método callback
   * @param evento ClusterNetEventNewData
   */

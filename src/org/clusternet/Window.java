...
//------------------------------------------------------------
//
//	Fichero: Window.java  1.0
//
//
//	Descripción: Clase Window. Window independiente de la implementación
//                   realizada.
//
// 	Authors: 
...
/**
 * Clase Window. Define los métodos de una ventana y los redirige a la
 * implementación obtenida del método fábrica de la clase ImpWindow, consiguiendo
...
//==========================================================================
/**
 * Invoca el método fábrica de {@link ImpWindow} para obtener una implementación
 * concreta de ventana.
 ...
 */
public Window (int iTamañoMaximo,long lNSecInicial)
                                throws ClusterNetInvalidParameterException
 {
  this.impWindow = ImpWindow.getImpVentana (iTamañoMaximo,lNSecInicial);
...
{
 if (this.impWindow!=null)
    return this.impWindow.impGetNumSecInicial();
 return -1;
}
...
{
  return this.impWindow.impGetNumSecFinal();
}
...
{
 return this.impWindow.impGetNumSecConsecutivo ();
}
...
{
 return this.impWindow.impContieneTPDUDatosNormal (lNSec);
}
                                ...
                                throws ClusterNetInvalidParameterException
{
  ...
  {
      if (this.iNuevo_tamaño > this.impWindow.impGetTamañoVentana())
        throw new ClusterNetInvalidParameterException("Window llena");
      else
      {
        this.impWindow.impCambiarCapacidadVentana(iNuevo_tamaño);
  ...
  tpdu = this.impWindow.impAddTPDUDatosNormal (lNSec,pqt);
 ...
 */
public void reiniciar (long lNSec) throws ClusterNetInvalidParameterException
{
  this.impWindow.impReiniciar (lNSec);
...
{
  return this.impWindow.impGetTPDUDatosNormal(lNSec);
}
...
{
  return this.impWindow.impGetTPDUDatosNormalMenorIgual (lNSec);
}
...
public TPDUDatosNormal getTPDUNSecMayor ()
{
 ...
 return this.impWindow.impGetTPDUDatosNormal (this.getNumSecMayor());
}
...
{
  final String mn = "Window.removeTPDUDatosNoraml()";
  TPDUDatosNormal tpdu = null;

  //Log.debug (Log.VENTANA,mn,"");

  tpdu = this.impWindow.impRemoveTPDUDatosNormal ();

  if ((this.iNuevo_tamaño != 0) && (this.iNuevo_tamaño >= this.impWindow.impGetTamañoVentana()))
  {
        this.impWindow.impCambiarCapacidadVentana(iNuevo_tamaño);
        this.iNuevo_tamaño = 0;
  }
...
{
  final String mn = "Window.removeTPDUDatosNoraml(nSec)";

  //Log.debug (Log.VENTANA,mn,""+nSec);

  this.impWindow.impRemoveTPDUDatosNormal(lNSec);
  if ((this.iNuevo_tamaño != 0) && (this.iNuevo_tamaño >= this.impWindow.impGetTamañoVentana()))
  {
        this.impWindow.impCambiarCapacidadVentana(iNuevo_tamaño);
        this.iNuevo_tamaño = 0;
  ...
  try{
    this.treeMapNSecTPDUConACK.headMap (new SecuenceNumber (lNSec+1)).clear();
...
{
  return this.impWindow.impGetCapacidadVentana ();
}
...
public void setCapacidadVentana (int iNuevoTamañoMaximo)
{
  ...
  if (this.impWindow.impGetTamañoVentana() <= this.iNuevo_tamaño)
  {
    this.impWindow.impCambiarCapacidadVentana(this.iNuevo_tamaño);
    this.iNuevo_tamaño = 0;
  }
}
...
{
  return this.impWindow.impGetNumSecMayor ();
}

  //============================================================================
  /**
   * Devuelve un treemap con los números de secuencia de los tpdu que tienen el
   * bit ACK activado. Esta indexado por SecuenceNumber al que se le asocia null.
  ...
  */
   ...
   */
   public TPDUDatosNormal getPrimerTPDUConACKActivado ()
   {
    ...
    SecuenceNumber nSec = (SecuenceNumber)this.treeMapNSecTPDUConACK.firstKey();
...
/*  public void setTiempo (long tiempoMsg)
  ...
  */
  ...
  {
   return this.impWindow.toString();
  }

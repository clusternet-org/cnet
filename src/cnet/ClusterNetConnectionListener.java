...
//------------------------------------------------------------
//
//	File: ClusterNetConnectionListener.java  1.0 24/9/99
//
//
//	Description: Clase ClusterNetConnectionListener.
//
// 	Authors: 
...
/**
 * Interfaz ClusterNetConnectionListener.
 * Notificación de mensajes informativos por parte del socket ClusterNet
...
public interface ClusterNetConnectionListener
{
  //==========================================================================
  /**
   * El método callback
   * @param evento ClusterNetEventConnection
   */

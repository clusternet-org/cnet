    ...
    ,ClusterNetConnectionListener, ClusterNetGroupListener, ClusterNetMemberListener
{
 ...
 void waitReceiveFiles() throws IOException
 {
    ...
    //Información..
    cFtp.getFTP().insertInformacionString("Esperando recepción de ficheros...");
    cFtp.getFTP().insertRecepcionString("Esperando recepción de ficheros...","icono_informacion");
 ...
 private void recibirDatagrama() throws IOException
 {
   ...
   if(!this.treemapID_Socket.containsKey(reg.getID_Socket()))
   {
       ...
       cFtp.getFTP().insertRecepcionString("Iniciando la recepción... de "+sFileName,null);
       ...
       //this.getFTP().insertStringJTextPane(" ","icono_entrada");
       cFtp.getFTP().insertRecepcionString("Tamaño: "+lFileSize,null);

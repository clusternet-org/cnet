...
public class cFtp implements I18n
{
  ...
  /** Copyright */
  public static String VERSION = "cftp v1.2";


  /** Sesión Multicast */
  private ProtocolcFTP sesionMulticast = null;
  ...
  * @return
  */
  ProtocolcFTP getSesionMulticast()
 {
 ...
 static Image getImage(String fileName)
 {
        ...
        //Obtener la imágen...
        URL url = cFtp.class.getResource(fileName);
        /*if(this.esApplet())
        {

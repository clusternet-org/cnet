...
/**
 * This class is a thread for data reception
 * 
 */
    ...
    ,ClusterNetConnectionListener, ClusterNetGroupListener, ClusterNetMemberListener
{
  ...
  * Constructor
  */
  public receive(String dirIPMulticast, String puerto) throws IOException
  {
    super("receive");
    ...
    System.out.println("");
    System.out.println("-------------------------------------------");
    System.out.println("receive v1.0");
 ...
 {
    if(this.modo == ClusterNet.MODE_DELAYED_RELIABLE || this.modo  == ClusterNet.MODE_RELIABLE)
    {
    ...
    else
    {
      ...
      this.socket.addRxDataListener(this);
 ...
 private void recibirDatagrama() throws IOException
 {
   ...
   {
       Log.log(mn,"NUEVO ClusterMemberID: "+reg.getID_Socket());
 ...
 public void actionPTMFIDGL(ClusterNetEventGroup evento)
 {
    ...
    if( evento.esAñadido())
    {
       //Log.log("IDGLS: "+runGUI.getGUI().idgls,"");
 ...
 public void actionID_Socket(ClusterNetEventMember evento)
 {
    ...
    if( evento.esAñadido())
    {
       //Log.log("ID_Sockets: "+runGUI.getGUI().id_sockets,"");
 ...
 //==========================================================================
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      receive receptorFtpMulticast = new receive(args[0],args[1]);

...
import cnet.Log;
import cnet.Mutex;
import cnet.RegistroBuffer;
import cnet.Semaforo;
import cnet.SocketClusterNetImp;
import cnet.TimerHandler;
...
public class ID_SocketInputStream extends InputStream implements TimerHandler, Comparable
{
   ...
   * Constructor.
   */
  ID_SocketInputStream(ID_Socket id_socket,SocketClusterNetImp socket)
  {
   super();

...
import cnet.ClusterNetEventConnection;
...
/**
 * CCopy v 1.0 
 * <p>Title: ClusterNet v1.0</p>
 * <p>Description: this class send a file to all clusterNet members using CCopy protocol.</p>
 * <p>Copyright: Copyright (c)2016 - clusternet.org</p>
 * 
 * @author Alejandro Garcia Dominguez (alejandro.garcia.dominguez@gmail.com)
 * @version 1.0
 * 
 */
    ...
    ,ClusterNetConnectionListener, ClusterNetGroupListener, ClusterNetMemberListener
{
  ...
  * Constructor
  */
  public send(String dirIPMulticast, String puerto, String sFichero) throws IOException
  {
    super("send");
...
*/
 ...
 public void actionPTMFIDGL(ClusterNetEventGroup evento)
 {
    ...
    if( evento.esAñadido())
    {
       //Log.log("IDGLS: "+runGUI.getFTP().idgls,"");
 ...
 public void actionID_Socket(ClusterNetEventMember evento)
 {
    ...
    if( evento.esAñadido())
    {
       //Log.log("ID_Sockets: "+runGUI.getFTP().id_sockets,"");
...
*/
 ...
 //==========================================================================
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      send emisorFtpMulticast = new send(args[0],args[1],args[2]);
   ...
   */
   void sendFile() throws IOException
   {
     ...
     try
     {
          ...
          Log.log(mn,"Iniciando transferencia runGUI....");
 ...
 private void sendBytes(byte[] aBytes,int iBytes) throws IOException
 {
    ...
    || this.modo == ClusterNet.MODE_RELIABLE)
    {
      ...
      // Log.log("====================================================","");
      // Log.log("send.sendBytes:",new String(aBytes,0,iBytes));
      // Log.log("====================================================","");
    }
    else
    {

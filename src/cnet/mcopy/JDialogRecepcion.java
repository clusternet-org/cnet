...
import java.lang.Math;
  ...
  */
 public JDialogRecepcion(Frame frame, String title,
  ...
  */
  private JLabel getJLabelLogo()
  {
        ...
        jLabelLogo.setIcon(new ImageIcon( runGUI.getImage("bola.gif")));

        jLabelLogo.setAlignmentX(Component.RIGHT_ALIGNMENT);
        jLabelLogo.setToolTipText("Power Transport Multicast Framework (ClusterNet).");
   ...
   */
   private JPanel getpanel5()
   {
      if (panel5 == null)
      {
        ...
        //        BorderFactory.createEmptyBorder(0,0,0,0)),"Channel seguro:"));
   ...
   */
   private JButton getjButtonCancelar()
   {
      if (jButtonCancelar == null)
      {
        ...
        jButtonCancelar.setIcon(new ImageIcon(runGUI.getImage("desconectar.gif")));
      }
 ...
 public  static void main(String[] args)
  {
   ...
   JDialogRecepcion conectar =  new JDialogRecepcion(null,"Multicast reception...",false,"Iniciando...",0,null,null);

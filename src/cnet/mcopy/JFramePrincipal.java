...
public class JFramePrincipal extends JFrame
{
  ...
  //JTextPane jTextPaneInformacion = runGUI.getJTextPane();
  ...
  /**
   * Frame principal de runGUI. Este frame se ha generado con el editor gráfico,
  ...
  {
    //Cargar imágenes...
    ImageIconLogoOff = new ImageIcon(runGUI.getImage("grey_ball.gif"));
    ImageIconLogoOn = new ImageIcon(runGUI.getImage("green_ball.gif"));
  ...
  private void iniciarEstilos()
  {
   //Iniciar estilos
    // ================ Panel Información =========================
    runGUI.iniciarStylesJTextPane(jTextPaneInformacion);
    copyright();
    jTextPaneInformacion.getLayout().addLayoutComponent("jTextPaneInformacion",jTextPaneInformacion);


    // ================ Panel Receptores  =========================
    runGUI.iniciarStylesJTextPane(jTextPaneReceptor);
    runGUI.insertRecepcionString("Receiver","icono_informacion");


    // ================ Panel Transmisor  =========================
    runGUI.iniciarStylesJTextPane(jTextPaneTransmisor);
    runGUI.insertTransmisionString("Sender","icono_informacion");
  ...
  private  void crearArbolInformacion()
  {
      ...
      /*
          //Crear el nodo raíz
          DefaultMutableTreeNode top = new DefaultMutableTreeNode("ClusterNet");
            ...
            public void valueChanged(TreeSelectionEvent e)
            {
              ...
              //                         jTreeInformacion.getLastSelectedPathComponent();
                ...
                if (node.isLeaf())
                {
                  ...
                  //runGUI.insertInformacion(jTextPaneInformacion,"panel cambiado");
  ...
  private void jbInit() throws Exception
  {
    ...
    jLabel3.setText(" clusterNET - runGUI v1.2");
    ...
    jLabelPTMF.setText("   ");
    jLabelPTMF.setIcon(new ImageIcon(JFramePrincipal.class.getResource("grey_ball.jpg")));
   ...
   //this.setContentPane(jPanelContentPanel);
    ...
    this.setTitle("cFTP - a cluster file sharing");
    ...
    jButtonRxCancelar.setIcon(new ImageIcon(JFramePrincipal.class.getResource("desconectar.gif")));
    ...
    jButtonTxEnviar.setIcon(new ImageIcon(JFramePrincipal.class.getResource("enviar.gif")));
    ...
    jButtonDesconectar.setIcon(new ImageIcon(JFramePrincipal.class.getResource("desconectar.gif")));
    ...
    jButtonConectar.setDisabledIcon(new ImageIcon(JFramePrincipal.class.getResource("conectar_inhabilitado.gif")));
    jButtonConectar.setIcon(new ImageIcon(JFramePrincipal.class.getResource("conectar.gif")));
    ...
    jTextArea1.setText("(C) Copyright 2016  \n"
    ...
    jLabel1.setText(" (C)2016 clusterNET - runGUI, a cluster ftp program");
    ...
    jLabel2.setPreferredSize(new Dimension(180, 120));
    jLabel2.setHorizontalAlignment(SwingConstants.LEFT);
    jLabel2.setHorizontalTextPosition(SwingConstants.LEFT);
    jLabel2.setIcon(new ImageIcon(JFramePrincipal.class.getResource("clusterNET.jpg")));
    jLabel2.setText("  ");
  ...
  {
    //Conectar.
    //runGUI.getGUI().getJDialogConectar().show();
  }
  ...
  void jButtonTxEnviar_actionPerformed(ActionEvent e)
  {
    ...
    if( this.jFileChooser.showDialog(this,"Send") == JFileChooser.APPROVE_OPTION )
    {
       ...
       {
          JOptionPane.showMessageDialog(this,"Any file selected for transmission."+runGUI.newline+"Please, select a file"+runGUI.newline+"You can use double click on the directory tree ","File don't selected.",JOptionPane.INFORMATION_MESSAGE);
          return;
       }
       ...
       if (JOptionPane.showConfirmDialog(this,"Send file "+this.jFileChooser.getSelectedFile().getAbsolutePath(),"Confirmación",JOptionPane.OK_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE) == JOptionPane.OK_OPTION)
       {
           ...
           {
             JOptionPane.showMessageDialog(this,"There isn't multicast connection."+runGUI.newline+"Please init a multicast connection"+runGUI.newline+"Push \"Connect\" button"+runGUI.newline+"to init a new multicast connection","Disconnect",JOptionPane.INFORMATION_MESSAGE);
             return;
           }
  ...
  void copyright()
  {
    runGUI.insertInformacionString(runGUI.COPYRIGHT);
    runGUI.insertInformacionString(" "+runGUI.VERSION);
  ...
  */
  void logoOn()
  {
    ...
    runGUI.getGUI().insertRecepcionString("Receiver","icono_informacion");

    this.jTextPaneTransmisor.setText("");
    runGUI.getGUI().insertTransmisionString("Sender","icono_informacion");

    if(runGUI.getGUI().esEmisor())
    {

...
//----------------------------------------------------------------------------
//
//	File: UnsecureUnicastChannel.java  1.0 15/09/99
//
//
//	Description: Class UnsecureUnicastChannel.
//
// 	Authors: 
...
/**
 * Esta clase representa un canal unicast UDP/IP.
...
public class UnsecureUnicastChannel extends UnicastChannel
{
   ...
   * @exception ClusterNetExcepcion Socket nulo.
   * @exception ClusterNetInvalidParameterException Parámetro inválido
   * @exception IOException Error creando el socket o estableciendo la interfaz
   *  de salida de los datos multicast.
   */
  public UnsecureUnicastChannel(Address bindAddr)
   ...
   *  datos multicast.
   * @exception UnknownHostException, ClusterNetExcepcion
   */
  public UnsecureUnicastChannel(Address bindAddr,  Address ifMcast)
      throws ClusterNetExcepcion, IOException
  {
    final String  mn = "UnsecureUnicastChannel.CanalUnicastNoSeguro";
    ...
    {
      throw new ClusterNetExcepcion(mn, "Error en la creación del socket. Socket nulo.");
    }
    ...
    if(ifMcast!=null)
    {
      ...
      {
        throw new ClusterNetExcepcion(mn, "No se puede establecer como interfaz una dirección multicast");
      }
  ...
  public synchronized void send(Buffer buf,Address dirUnicastDestino)
     throws ClusterNetExcepcion, ClusterNetInvalidParameterException, IOException
  {
    final String    mn = "UnsecureUnicastChannel.send(Buffer,Address)";
    ...
    {
       throw new ClusterNetExcepcion(mn, "No se ha especificado una dirección unicast destino.");
    }
    ...
    {
     throw new ClusterNetInvalidParameterException(mn, "Argumentos requeridos erróneos.");
    }
    if ((buf.getBuffer() == null) || (buf.getLength() <= 0))
    {
          throw new ClusterNetInvalidParameterException(mn, "Buffer erróneo. Nulo o longitud errónea.");
    }
  ...
  public void receive(Buffer buf, Address src)
    throws ClusterNetExcepcion, ClusterNetInvalidParameterException, IOException
  {
    final String    mn = "UnsecureUnicastChannel.receive(Buffer,Address)";
  ...
  {
    final String  mn = "UnsecureUnicastChannel.setTTL(byte)";
  ...
  {
    final String  mn = "UnsecureUnicastChannel.setCallback(ChannelCallback,int)";
    ...
    if (!this.callback)
    {
      ...
      {
        throw new ClusterNetExcepcion(mn, "Excepción en el timeout del socket.");
      }
  ...
  {
    final String  mn = "MulticastChannel.disableCallback()";
...
/**
 * Thread de recepción del Channel Unicast.<br> Thread demonio.<br>
...
class UnicastThreadNoSeguro extends Thread
{
 /** El canal unicast que creó este thread. */
  private UnsecureUnicastChannel  canalObj = null;
   ...
   */
   public UnicastThreadNoSeguro(UnsecureUnicastChannel canal, MulticastSocket sock)
  {
   ...
   * a la clase UnsecureUnicastChannel cual es el objeto callback registrado y su
   * argumento.
   */
  public void run()
  {

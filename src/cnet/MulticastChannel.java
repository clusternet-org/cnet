...
//----------------------------------------------------------------------------
//
//	File: MulticastChannel.java  1.0 13/09/99
//
//	Description: Class MulticastChannel.
//
// 	Authors: 
...
/**
 * Clase que representa un <STRONG><b>Channel Multicast Genérico</b></STRONG>.<br>
...
public abstract class MulticastChannel 
{
  ...
  //==========================================================================
  /**
   * Método Fábrica para crear un Channel Multicast No Seguro o Seguro.<br>
   * La creación de un Channel Multicast Seguro la determina el parámetro cipher
   *
   ...
   *  multicast.
   */
    public static MulticastChannel getInstance(Address grupoMcast,  Address ifMcast,
    javax.crypto.Cipher cipher, javax.crypto.Cipher unCipher) throws ClusterNetExcepcion
   {
     if(cipher == null && unCipher == null)
       return new UnsecureMulticastChannel(grupoMcast,ifMcast);
     else
      return new SecureMulticastChannel(grupoMcast,ifMcast,cipher,unCipher);
   }

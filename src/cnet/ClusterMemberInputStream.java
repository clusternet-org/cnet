...
//----------------------------------------------------------------------------
//
//	Fichero: ClusterMemberInputStream.java  1.0 24/11/99
//
//	Description: Clase ClusterMemberInputStream.
//
// 	Authors: 
...
/**
 * ClusterMemberInputStream es un stream de entrada para un determinado
 * ClusterMemberID.<br>
 * Los métodos read() son síncronos. Utilice los Eventos ClusterNetEvent para
 ...
 */
public class ClusterMemberInputStream extends InputStream implements TimerHandler, Comparable
{
  /** Lista para almacenar los objetos Buffer */
  private LinkedList lista = null;

  /** ClusterMemberID de este flujo */
   ...
   * Constructor.
   */
  ClusterMemberInputStream(ClusterMemberID id_socket,SocketClusterNetImp socket)
  {
   super();
   ...
   */
   private void sendPTMFEventDatosRecibidos(String mensaje,int nBytes)
   {
    ...
    {
     ClusterNetEventNewData evento = new ClusterNetEventNewData(this.socket,mensaje,nBytes);
     ...
     while(iterator.hasNext())
     {
        ...
        ptmfListener.actionRxData(evento);
     }
    }
   }
   ...
   */
   public int read()  throws IOException
   {
     ...
     if (bClose)
       return -1;
      //hrow new IOException("El Flujo ClusterMemberInputStream está cerrado.");
   ...
   {
       String mn = "ClusterMemberInputStream.getNextBuffer.";
       boolean in = false;
...

       {
        ...
        else
        {
         ...
         {
          this.bClose = true;
          Log.debug(Log.ID_SOCKETINPUTSTREAM,mn,"ClusterMemberInputStream: getNextBuffer() --> FIN DEL FLUJO ");
          //Eliminar este ClusterMemberInputStream de la Cola de Recepcion
   ...
   */
   public int read(byte[] b, int off, int len) throws IOException
   {
     ...
     if (bClose)
      return -1;
      //throw new IOException("El Flujo ClusterMemberInputStream está cerrado.");
   ...
   * @param  ClusterMemberInputStream con la que se compara.
   * @return mayor que cero si este ClusterGroupID es mayor que el pasado en el
 ...
 public int compareTo(Object obj)
 {
    ...
    ClusterMemberInputStream id = (ClusterMemberInputStream) obj;

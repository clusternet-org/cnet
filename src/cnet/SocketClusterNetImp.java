...
class SocketClusterNetImp
{
 ...
 //==========================================================================
  ...
  //==========================================================================
  /**
   * Envía un evento ClusterNetEventConnection con una cadena informativa.
   ...
   */
   void sendPTMFEventConexion(String mensaje)
   {
    ...
    {
     ClusterNetEventConnection evento = new ClusterNetEventConnection(this,mensaje);
   ...
   * registren de un evento ClusterNetEventConnection

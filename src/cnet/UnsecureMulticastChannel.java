...
//----------------------------------------------------------------------------
//
//	File: UnsecureMulticastChannel.java  1.0 13/09/99
//
//	Description: Class UnsecureMulticastChannel.
//
// 	Authors: 
...
class UnsecureMulticastChannel extends MulticastChannel
{
  /** Dirección Multicast */
  ...
  * callback está activado */
   ...
   *  grupo multicast.
   */
  UnsecureMulticastChannel(Address grupoMcast) throws ClusterNetExcepcion
  {
   ...
   *  multicast.
   */
  UnsecureMulticastChannel(Address grupoMcast,  Address ifMcast) throws ClusterNetExcepcion
  {
    final String  mn = "UnsecureMulticastChannel.CanalMulticastNoSeguro(Address,Address)";
    ...
    try
    {
      ...
      //Log.debug(Log.CANAL_MULTICAST,"UnsecureMulticastChannel.CanalMulticastNoSeguro","Socket Multicast "+grupoMcast+"--> OK");
          ...
          (!ifMcast.isMulticastAddress()))
      {
          ...
          //Log.debug(Log.CANAL_MULTICAST,"UnsecureMulticastChannel.CanalMulticastNoSeguro","Socket Multicast Interface "+ifMcast+"--> OK");
      }
      ...
      if (grupoMcast.isMulticastAddress())
      {
        ...
        //Log.debug(Log.CANAL_MULTICAST,"UnsecureMulticastChannel.CanalMulticastNoSeguro","Socket Multicast join --> OK");
      }
  ...
  public synchronized void close()
  {
   ...
   //Log.debug(Log.CANAL_MULTICAST,"UnsecureMulticastChannel.close","Socket Multicast close --> OK");
  }
...
long nBytesEnviados = 0;
  public synchronized void send(Buffer buf,  byte TTL)
   throws ClusterNetExcepcion, ClusterNetInvalidParameterException, IOException
  {
    final String    mn = "UnsecureMulticastChannel.send";
    ...
    {
        //Log.log("UnsecureMulticastChannel.send","Datagrama: longitud:"+buf.getLength()+" destino: "+this.addressMcast+" TTL--> "+TTL);
  ...
  public void receive(Buffer buf, Address src)
   throws ClusterNetExcepcion, ClusterNetInvalidParameterException, IOException
  {
    final String    mn = "UnsecureMulticastChannel.receive(Buffer,Address)";

    //Log.debug(Log.CANAL_MULTICAST,"UnsecureMulticastChannel.receive","Socket Multicast receive.");
  ...
  {
    final String  mn = "UnsecureMulticastChannel.setTTL(byte)";
  ...
  {
    final String  mn = "UnsecureMulticastChannel.setCallback(ChannelCallback,int)";
    ...
    //Log.debug(Log.CANAL_MULTICAST,"UnsecureMulticastChannel","Callback registrado: obj:"+obj+" arg:"+arg);
  ...
  {
    final String  mn = "UnsecureMulticastChannel.disableCallback()";
...
class MulticastThreadNoSeguro extends Thread
{
  ...
  private UnsecureMulticastChannel  canalObj = null;
   ...
   */
  public MulticastThreadNoSeguro(UnsecureMulticastChannel canal, MulticastSocket sock)
  {
  ...
  public void run()
  {
    ...
    try{
      buf = new Buffer(ClusterNet.TPDU_MAX_SIZE);
    }
    ...
    while (forever)
    {
      //buf.setMaxLength (ClusterNet.TPDU_MAX_SIZE);

 ...
 *
 * <p>Description: Test  multicast network utility</p>
 * This program send multicast packets to a give multicast address and port.
 ...
 * @version 1.0
 */
public class mPingSenderSimple {
    public mPingSenderSimple() {
    }
...
//==========================================================================
    ...
    * Constructor
    */
    public mPingSenderSimple(String dirIPMulticast, String puerto,String ttl) throws IOException
    {
    System.out.println("");
    System.out.println("");
    System.out.println("mPingSenderSimple v1.1");
    System.out.println("(C)2016 org.clusternet //  M.Alejandro Garcia");
    ...
    */
    ...
    try
    {
        ...
        while(true)
        {
            ...
            Log.log("","[mPingSenderSimple "+contador+"] "+dirIPMcast.getHostAddress()+":"+dirIPMcast.getPort());

            contador =contador+1;
            cnet.ClusterTimer.sleep(1000);
        }
...
//==========================================================================
    ...
    */
    ...
    {
    System.out.println("");
    System.out.println("mPingSenderSimple v1.0" );
    System.out.println("(C) 2005-2014 Alejandro Garcia");
    System.out.println("Uso: java org.clusternet.tools.mPingSender <dir. ip multicast> <puerto> <ttl>");
    System.out.println("");
    System.out.println("");
    }
    ...
    */
    ...
    /**
      ...
      */
      ...
      try
      {
          mPingSenderSimple mping = new mPingSenderSimple(args[0],args[1],args[2]);
          mping.run();
      }

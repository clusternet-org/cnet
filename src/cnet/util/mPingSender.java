    ...
    */
    ...
    try
    {
        ...
        while(true)
        {
            ...
            String msg= "sequence "+contador;//+" "+add+"->"+dirIPMcast;
            DatagramPacket hi = new DatagramPacket(msg.getBytes(), msg.length(),dirIPMcast.getInetAddress(),dirIPMcast.getPort());
            socket.send(hi);

            Log.log("mping "+contador,"mping send to -> "+dirIPMcast.getHostAddress()+":"+dirIPMcast.getPort());
...
//==========================================================================
    ...
    */
    ...
    System.out.println("");
    System.out.println("mPingSender v1.1" );
    System.out.println("Uso: java cnet.ping.mPingSender <multicast address> <port> <ttl>");
    System.out.println("");
    System.out.println("");
    }

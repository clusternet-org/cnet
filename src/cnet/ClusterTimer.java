...
//
//
//	Descripción: Clase ClusterTimer. Proporciona métodos útiles para
...
public class  ClusterTimer
{
  ...
  * cuando se supere el tiempo máximo de espera ({@link ClusterNet#OPORTUNIDADES_RTT} * {@link ClusterNet#RTT})<br>
  ...
  */
   ...
   */
  private  final int iINTENTOS = ClusterNet.OPORTUNIDADES_RTT + 1; // Número de intentos para dar por finalizado un NS.
...
public  synchronized boolean registradaFuncionRTT ()
{
  ...
  * Cuando se alcance la espera máxima ({@link ClusterNet#OPORTUNIDADES_RTT} * {@link ClusterNet#RTT})
 ...
 * @throws ErrorInitTempException Excepción lanzada si hay un error al
...
class ThreadTemporizador extends Thread
{
 ...
 public ThreadTemporizador (ClusterTimer temporizadorParam)
 {
   ...
   * función {@link ClusterTimer#buscarSiguiente(long)} para averiguar los

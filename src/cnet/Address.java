...
// 
//  History:
//     7.04.2015 Changed licence to Apache 2.0     
//
...
public class Address implements Cloneable,Comparable
{
  ...
  /** An string description this address use*/
  String Name; 
...
PROBAR SI HACE RESOLUCI�N DE NOMBRES (DNS)
   ...
   * @param puerto Puerto TCP/UDP
   * @exception ClusterNetInvalidParameterException lanzada si dir es null
   */
  public Address(InetAddress dir,int puerto) throws ClusterNetInvalidParameterException
  {
    super();
    ...
    if (dir==null)
      throw new ClusterNetInvalidParameterException (mn,"dir no puede ser null.");

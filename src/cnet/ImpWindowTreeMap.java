...
//------------------------------------------------------------
//
//	File: ImpWindowTreeMap.java  1.0
//
//
//	Descripción: Clase ImpWindowTreeMap. Implementa la clase abstracta
//                   ImpWindow, localizando memoria conforme se va necesitando.
//
// 	Authors: 
 ...
 */
public class ImpWindowTreeMap extends ImpWindow
{
 ...
 * @throws ClusterNetInvalidParameterException lanzada si el número de secuencia no es válido.
 * @see OutOfMemoryError
 */
public ImpWindowTreeMap (int iTamañoMaximo,long lNSecInic) throws ClusterNetInvalidParameterException
{

 if (lNSecInic<0)
     { this.iCapacidadVentana = 0;
       this.lNumeroSecInicial = -1;
       throw new ClusterNetInvalidParameterException ("Número de sec " + lNSecInic
                                              + " no es válido.");
     }
                                        ...
                                        throws ClusterNetInvalidParameterException
{
 ...
 if ((lNSec>impGetNumSecFinal())||(lNSec<impGetNumSecInicial()))
     throw new ClusterNetInvalidParameterException ("El número de secuencia "+lNSec+
 ...
 */
public void impReiniciar (long lNSec) throws ClusterNetInvalidParameterException
{
 if (lNSec<0)
       throw new ClusterNetInvalidParameterException ("No es válido un número de secuencia menor que cero.");

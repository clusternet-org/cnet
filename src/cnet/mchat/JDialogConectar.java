...
import java.net.InetAddress;
  ...
  */
 public JDialogConectar(runGUI chatMulticast,Frame frame, String title, boolean modal) {
  ...
  * modal
  */
  public JDialogConectar(runGUI chatMulticast) {
 ...
 //==========================================================================
   ...
   */
   private JCheckBox  getjChekBoxSSL()
   {
      if (jChekBoxSSL == null)
      {
        jChekBoxSSL = new JCheckBox("Channel Multicast Seguro (RC2)");
        jChekBoxSSL.setToolTipText("Activar/Desactivar Channel Multicast Seguro");
   ...
   */
   private JRadioButton getjRadioButtonFiable()
   {
      if (jRadioButtonFiable  == null)
      {
        ...
        jRadioButtonFiable.setToolTipText("Modo FIABLE de ClusterNet");
   ...
   */
   private JRadioButton getjRadioButtonNoFiable()
   {
      if (jRadioButtonNoFiable  == null)
      {
        ...
        jRadioButtonNoFiable.setToolTipText("Modo NO-FIABLE de ClusterNet");
   ...
   */
   private JRadioButton getjRadioButtonNoFiableOrdenado()
   {
      if (jRadioButtonNoFiableOrdenado  == null)
      {
        ...
        jRadioButtonNoFiableOrdenado.setToolTipText("Modo NO-FIABLE-ORDENADO de ClusterNet");
  ...
  public int getModo()
   {
      if (this.getjRadioButtonFiable().isSelected())
        return ClusterNet.MODE_DELAYED_RELIABLE;
      else if (this.getjRadioButtonNoFiableOrdenado().isSelected())
        return ClusterNet.MODE_NO_RELIABLE_ORDERED;
      else
        return ClusterNet.MODE_NO_RELIABLE;
    }

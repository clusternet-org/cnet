...
/**
 * 	<b>Una Interfaz para runGUI, con soporte de
...
public class runGUI implements I18n
{
  ...
  * Constructor genérico para un applet y una aplicación.
	...
	*/
	public runGUI(javax.swing.JApplet unApplet) {
		 super();
		 jApplet = unApplet;
...
//==========================================================================
  ...
  * @param nickName NickName utilizado en la sesion Chat Multicast
            ...
            int modo, String nickname,char[] clave)
  {
      ...
      this.getJFrame().setTitle("clusterNet: runGUI - "+sIPMulticast+":"+ttlSesion);

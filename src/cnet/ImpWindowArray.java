...
//------------------------------------------------------------
//
//	Fichero: ImpWindowArray.java  1.0
//
//	Description: Clase ImpWindowArray. Implementa la clase abstracta
//                   ImpWindow, utilizando memoria estática, la cual es
 ...
 */
public class ImpWindowArray extends ImpWindow
{
 ...
 */
public ImpWindowArray (int iTamañoMaximo,long lNSecInic) throws ClusterNetInvalidParameterException
{
                                ...
                                throws ClusterNetInvalidParameterException
{
 ...
 else throw new ClusterNetInvalidParameterException ("El número de secuencia "+lNSec+
